...
1. **Initialization Bank** : 一个特殊的Init.Bnk文件，包含了Wwise工程所有的信息，例如：总线结构、State、Switche、RTPC。这个文件会在Wwise每次生产Bank文件时 **自动** 重新生成。 **该文件必须要使用其他****Bank****之前加载，否则其他****Bank****将无法正常解析。****（可以理解为****有基础依赖）**
