...
-  修改 `[引擎目录]\Engine\Config\BaseEngine.ini`
...
- 删除 `C:\Users\[UserName]\AppData\Local\UnrealEngine\Common\DerivedDataCache` 目录

- 启动`E:\junqiangzhu_trunk_ug_engine\UnrealEngine-release\Engine\Binaries\DotNET\SwarmAgent.exe` ，修改 `Settings -> CacheFolder` 设置

  - 若旧目录存在，则先删除旧目录  (C:\Users\ [User] \AppData\Local\UnrealEngine)
